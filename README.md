...
**API**|
1 | [Node (Employee Manager)](https://github.com/rodrigoclira/employee-manager-app-node-v1) e [Django Rest Framework (Employee Manager)](https://github.com/rodrigoclira/employee-manager-app-v1) | 
